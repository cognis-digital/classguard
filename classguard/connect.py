"""Native cognis-connect emit for classguard — forward findings to any platform.

Maps classguard's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    classguard ... --format json | classguard-emit --to stix
    classguard-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
