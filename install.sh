#!/usr/bin/env sh
# Universal installer for classguard. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/classguard.git"
echo "Installing classguard ..."
